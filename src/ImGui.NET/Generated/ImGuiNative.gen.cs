...
namespace ImGuiNET
{
    public static unsafe partial class ImGuiNative
    {
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void igGetKeyChordName(ImGuiModFlags mods, ImGuiKey key, byte* out_buf, int out_buf_size);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern void igGetKeyVector2d(Vector2* pOut, ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte igImageButtonEx(uint id, IntPtr texture_id, Vector2 size, Vector2 uv0, Vector2 uv1, Vector4 bg_col, Vector4 tint_col);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte igIsKeyPressedEx(ImGuiKey key, ImGuiInputFlags flags);
        [DllImport("cimgui", CallingConvention = CallingConvention.Cdecl)]
